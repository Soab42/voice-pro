  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1>Call Center</h1>
          <p className="text-gray-600">Manage customer calls with AI-powered assistance</p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div key={call.id} className="p-4 border border-gray-200 rounded-lg">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        ...
                        <p className="text-xs text-gray-600 mb-1">{call.customerNumber}</p>
                        <div className="flex items-center space-x-2">
                          <Badge variant="secondary">{call.accountType}</Badge>
                          <Badge className={call.priority === 'High' ? 'bg-red-100 text-red-700' : 'bg-yellow-100 text-yellow-700'}>
                            {call.priority}
                          </Badge>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="text-sm text-red-600">Wait: {call.waitTime}</p>
                        <p className="text-xs text-gray-500">{call.issue}</p>
                      </div>
                    </div>
                    <div className="flex space-x-2">
                      <Button size="sm" className="flex-1" onClick={() => handleAnswerCall(call)}>
                        <Phone className="mr-2 h-4 w-4" />
                        Answer
                      </Button>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Real-time assistance for better customer service</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <h4 className="text-sm text-blue-900 mb-2">Today's AI Insights</h4>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          ...
                          <Badge className={call.outcome === 'Resolved' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'}>
                            {call.outcome}
                          </Badge>
                        </div>
                        <p className="text-xs text-gray-600 mb-2">{call.notes}</p>
                      ...
                      <div className="flex items-center space-x-2">
                        <div className="flex items-center">
                          {[...Array(5)].map((_, i) => (
                            <Star
                              key={i}
                              className={`h-4 w-4 ${i < call.rating ? 'text-yellow-500 fill-current' : 'text-gray-300'}`}
                            />
                          ))}
                        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Daily call volume and patterns</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div className="bg-yellow-600 h-2 rounded-full" style={{ width: '94%' }} />
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <TabsContent value="settings" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure your call center preferences</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div>
                ...
                <div className="space-y-3 mt-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm">Enable real-time suggestions</span>
              ...
              <div>
                ...
                <div className="space-y-3 mt-3">
                  <div>
                    <Label htmlFor="queue-timeout">Queue timeout (minutes)</Label>
                    <Input id="queue-timeout" type="number" defaultValue="5" className="w-24" />
                  </div>
                  <div className="flex items-center justify-between">
